...
function DisplayProjectTodos(){
    ...
    projectArray.forEach((project) => {
        if (project.projectName === _utils_TodoMatcher__WEBPACK_IMPORTED_MODULE_3__.todoMatcher.matcher)
        {
...
function ProjectClicked(e){
    ...
    _utils_TodoMatcher__WEBPACK_IMPORTED_MODULE_1__.todoMatcher.matcher = e.target.textContent; 
...
function AddTodoToProject(){
    ...
    addTodoButton.src = _images_plus_svg__WEBPACK_IMPORTED_MODULE_3__;
...
function SubmitAddTodo(e){
    ...
    const result = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.compareAsc)(new Date(dueDate.getFullYear(), dueDate.getMonth(), dueDate.getDate() + 1),
    ...
    {
        const reformattedDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__.format)(new Date(dueDate.getFullYear(), dueDate.getMonth(), dueDate.getDate() + 1), 'MMM-dd-yyyy');

        projectArray.forEach((project) => {
            if (project.projectName === _utils_TodoMatcher__WEBPACK_IMPORTED_MODULE_1__.todoMatcher.matcher)
            {
